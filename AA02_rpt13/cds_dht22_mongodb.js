...
sp.on('data', function (data) { // call back when data is received
    ...
    secondcommaidx = readData.indexOf(',',firstcommaidx+1)+1; 
    ...
    // parsing data into signals
     if (readData.lastIndexOf(',') > firstcommaidx && firstcommaidx > 0) {
        ...
        humi = readData.substring(readData.indexOf(',',firstcommaidx+1) + 1, readData.lastIndexOf(',',secondcommaidx));
        lux = readData.substring(readData.lastIndexOf(',',secondcommaidx)+1,readData.lastIndexOf(','));
        time = readData.substring(readData.lastIndexOf(',')+1);
        readData = '';
